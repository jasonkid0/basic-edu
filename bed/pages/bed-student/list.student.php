                                        ...
                                        <table id="example2" class="table table-hover">
                                            ...
                                            <tbody class="border-bottom">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <?php
                                                        $select_prev = mysqli_query($conn, "SELECT * FROM tbl_schoolyears
                                                        ...
                                                        WHERE student_id = '$row[student_id]' ORDER BY ay_id DESC LIMIT 1");
                                                        $row2 = mysqli_fetch_array($select_prev);
                                                        
                                                        if ($row2['grade_level_id'] == '14' || $row2['grade_level_id'] == '15') {
                                                            echo $row2['grade_level'].' - '. $row2['strand_name'];
                                                        } else {
