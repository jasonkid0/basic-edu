    ...
    <script>
        ...
        function selectVal() {
            ...
            var grade_value = grade.value;
                                                                    if (grade_value == 11) {
                                                                        $('input.grade_14').each(function() {
                                                                            this.checked = true;
                                                                        });
                                                                        $('input.grade_15').each(function() {
                                                                            this.checked = false;
                                                                        });
                                                                    } else {
                                                                        $('input.grade_15').each(function() {
                                    ...
                                    <div class="row mt-4 justify-content-center">
                                        <div class="input-group col-sm-3">
                                            ...
                                            <select class="form-control select2 select2-info custom-select"
                                                ...
                                                data-placeholder="Select Grade Level" name="grade_level" id="grade_level" onchange="selectVal()">
                                                    ...
                                                    <tr>
                                                        <td>
                                                            ...
                                                            <div class="custom-control custom-checkbox">
                                                                <input
                                                                    class="custom-control-input custom-control-input-navy checkThis grade_<?php echo $row['grade_level_id'];?>"
                                                                    type="checkbox"
