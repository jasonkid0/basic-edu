                ...
                <section class="content">
                    <div class="container-fluid pl-5 pr-5 pb-3">
                        <div class="card card-info shadow-lg">
                            ...
                            <!-- /.card-header -->
                            <!-- form start -->
                            <form action="userData/ctrl.add.enrollment.breakdown.php" enctype="multipart/form-data" method="POST">
                                <div class="card-body">
                                    ...
                                    <div class="row mb-4">
                                        <div class="input-group col-sm-6 mb-2">
                                            ...
                                            <input type="text" class="form-control" name="daily_new[]"
                                                placeholder="Daily">
                                        </div>
                                        <div class="input-group col-sm-6 mb-2">
                                            <div class="input-group-prepend">
                                            ...
                                            <input type="text" class="form-control" name="daily_old[]"
                                                placeholder="Daily">
                                        </div>
                                    </div>
                                    <div class="row mb-4">
                                        <div class="input-group col-sm-6 mb-2">
                                            ...
                                            <input type="text" class="form-control" name="reservations_new[]"
                                        ...
                                        <div class="input-group col-sm-6 mb-2">
                                            ...
                                            <input type="text" class="form-control" name="reservations_old[]"
                                                placeholder="Reservations">
                                        </div>
                                    </div>
                                    <hr>
                                            ...
                                            <div class="row mb-4">
                                                <div class="input-group col-sm-4 mb-2">
                                                    ...
                                                    <input type="text" class="form-control" value="<?php echo $row2['strand_name'];?>"
                                                        placeholder="Target" disabled>
                                                        <input type="text" class="form-control" name="strand[]" value="<?php echo $row2['strand_id'];?>"
                                                        placeholder="Target" hidden >
                                                        <input type="text" class="form-control" name="grade_level[]" value="<?php echo $row['grade_level_id']?>"
                                                        placeholder="Target" hidden>
                                                </div>
