                                ...
                                <div class="card shadow">
                                    ...
                                    <div class="card-body j">
                                        <div class="row ustify-content-center">
                                            <?php
                                        $info = mysqli_query($conn, "SELECT * FROM tbl_information");
                                        while ($row = mysqli_fetch_array($info)) {
                                            $or = mysqli_query($conn, "SELECT * FROM tbl_online_reg WHERE info_id = '$row[info_id]'");
                                            $count = mysqli_num_rows($or);
                                            ?>
                                        <button type="button" class="btn bg-green text-sm p-2 mx-2 mb-md-2">
                                            <i class="fa fa-edit"></i>
                                            <?php echo $row['info_name']; ?> (<?php echo $count;?>)
                                        </button>
                                        <?php
                                        }
                                        ?>
