            ...
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
               ...
               with font-awesome or any other icon font library -->
                ...
                <li class="nav-item">
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="../bed-dashboard/enrollment.history.php" class="nav-link">
                                <i class="fa fa-list-alt nav-icon"> </i>
                                <p>
                                    Enrollment History
                                </p>
                ...
                <li class="nav-item">
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="../bed-announcement/add.announcement.php" class="nav-link">
                                <i class="fa fa-file-alt nav-icon"> </i>
                                <p class="ml-1"> Add Announcement</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="../bed-hedCurr/gas.php" class="nav-link">
                                <i class="fa fa-file-alt nav-icon"> </i>
                                <p class="ml-1"> List Announcement</p>
                            </a>
                        </li>
                    </ul>
                </li>
                <li class="nav-item">
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="../bed-enrollment-breakdown/set.target.php" class="nav-link">
                                <i class="fa fa-file-alt nav-icon"> </i>
                                <p class="ml-1"> Set Target</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="../bed-enrollment-breakdown/add.enrollment.breakdown.php" class="nav-link">
                                <i class="fa fa-file-alt nav-icon"> </i>
                                <p class="ml-1"> Add Daily Enrollees</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="../bed-enrollment-breakdown/list.enrollment.breakdown.php" class="nav-link">
                                <i class="fa fa-file-alt nav-icon"> </i>
                                <p class="ml-1"> Edit Daily Enrollees</p>
                            </a>
                        </li>
                    </ul>
                </li>
